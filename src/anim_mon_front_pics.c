...
const u32 gMonFrontPic_Crocalor[] = INCBIN_U32("graphics/pokemon/crocalor/anim_front.4bpp.lz");
const u32 gMonFrontPic_Skeledirge[] = INCBIN_U32("graphics/pokemon/skeledirge/anim_front.4bpp.lz");
