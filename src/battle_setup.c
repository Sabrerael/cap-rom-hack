...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_LOLA] = REMATCH(TRAINER_GERALD_2, TRAINER_AXLE_2, TRAINER_JEFF_2, TRAINER_COLE_2, TRAINER_EDWARDO_2, ROUTE109),
    [REMATCH_RICKY] = REMATCH(TRAINER_DARIUS_2, TRAINER_ASHLEY_2, TRAINER_FLINT_2, TRAINER_CRISSY_2, TRAINER_HUMBERTO_2, ROUTE109),
    ...
    [REMATCH_BROOKE] = REMATCH(TRAINER_BROOKE, TRAINER_MAURA_2, TRAINER_NATE_2, TRAINER_ANGEL_2, TRAINER_VIVIAN_2, ROUTE111),
    [REMATCH_WILTON] = REMATCH(TRAINER_WILTON_1, TRAINER_PRESTON_2, TRAINER_VIRGIL_2, TRAINER_BLAKE_2, TRAINER_HANNAH_2, ROUTE111),
    [REMATCH_VALERIE] = REMATCH(TRAINER_BETHANY_2, TRAINER_VALERIE_2, TRAINER_VALERIE_3, TRAINER_VALERIE_4, TRAINER_VALERIE_5, MT_PYRE_6F),
    ...
    [REMATCH_GABRIELLE] = REMATCH(TRAINER_TOMMY_2, TRAINER_GABRIELLE_2, TRAINER_GABRIELLE_3, TRAINER_GABRIELLE_4, TRAINER_GABRIELLE_5, MT_PYRE_3F),
    ...
    [REMATCH_SAWYER] = REMATCH(TRAINER_DARK_PSYSTORM, TRAINER_SAWYER_2, TRAINER_SAWYER_3, TRAINER_SAWYER_4, TRAINER_SAWYER_5, MT_CHIMNEY),
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_JADE_1, TRAINER_JADE_2, TRAINER_JADE_3, TRAINER_JADE_4, TRAINER_JADE_5, RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_BLIND_JIM_1, TRAINER_BLIND_JIM_2, TRAINER_BLIND_JIM_3, TRAINER_BLIND_JIM_4, TRAINER_BLIND_JIM_5, DEWFORD_TOWN),
    [REMATCH_WATTSON] = REMATCH(TRAINER_TREBLE_1, TRAINER_TREBLE_2, TRAINER_TREBLE_3, TRAINER_TREBLE_4, TRAINER_TREBLE_5, MAUVILLE_CITY),
    [REMATCH_FLANNERY] = REMATCH(TRAINER_SALSA_1, TRAINER_SALSA_2, TRAINER_SALSA_3, TRAINER_SALSA_4, TRAINER_SALSA_5, LAVARIDGE_TOWN),
    [REMATCH_NORMAN] = REMATCH(TRAINER_HERMES_1, TRAINER_HERMES_2, TRAINER_HERMES_3, TRAINER_HERMES_4, TRAINER_HERMES_5, PETALBURG_CITY),
    [REMATCH_WINONA] = REMATCH(TRAINER_TMONEY_1, TRAINER_TMONEY_2, TRAINER_TMONEY_3, TRAINER_TMONEY_4, TRAINER_TMONEY_5, FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TOT_1, TRAINER_TOT_2, TRAINER_TOT_3, TRAINER_TOT_4, TRAINER_TOT_5, MOSSDEEP_CITY),
    [REMATCH_JUAN] = REMATCH(TRAINER_SABRE_1, TRAINER_SABRE_2, TRAINER_SABRE_3, TRAINER_SABRE_4, TRAINER_SABRE_5, SOOTOPOLIS_CITY),
    [REMATCH_SIDNEY] = REMATCH(TRAINER_HAROLD, TRAINER_HAROLD, TRAINER_HAROLD, TRAINER_HAROLD, TRAINER_HAROLD, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_BUFF_RYAN, TRAINER_BUFF_RYAN, TRAINER_BUFF_RYAN, TRAINER_BUFF_RYAN, TRAINER_BUFF_RYAN, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_PIRATE, TRAINER_PIRATE, TRAINER_PIRATE, TRAINER_PIRATE, TRAINER_PIRATE, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_SUSFLAME, TRAINER_SUSFLAME, TRAINER_SUSFLAME, TRAINER_SUSFLAME, TRAINER_SUSFLAME, EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_ROCKHAB, TRAINER_ROCKHAB, TRAINER_ROCKHAB, TRAINER_ROCKHAB, TRAINER_ROCKHAB, EVER_GRANDE_CITY),
};
