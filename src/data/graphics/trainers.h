...
const u8 gTrainerBackPic_Ryan[] = INCBIN_U8("graphics/trainers/back_pics/ryan.4bpp");
...
const struct SpriteFrameImage gTrainerBackPicTable_Ryan[] =
{
    {gTrainerBackPic_Ryan + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Ryan + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Ryan + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Ryan + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};
...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(RYAN, 4, Ryan, Palette_Ryan, Hoenn),
};
