static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_CASTLE_TOWN_TMONEY - 1] = {MAP_GROUP(CASTLE_TOWN_TMONEY), MAP_NUM(CASTLE_TOWN_TMONEY), 12, 15},
    ...
    [HEAL_LOCATION_CASTLE_TOWN_ANDY - 1] = {MAP_GROUP(CASTLE_TOWN_ANDY), MAP_NUM(CASTLE_TOWN_ANDY), 24, 12},
};
