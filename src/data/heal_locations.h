static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_STARTING_TOWN - 1] = {MAP_GROUP(STARTING_TOWN), MAP_NUM(STARTING_TOWN), 14, 7},
    [HEAL_LOCATION_MIDDLE_TOWN_WEST - 1] = {MAP_GROUP(MIDDLE_TOWN_WEST), MAP_NUM(MIDDLE_TOWN_WEST), 19, 11},
    [HEAL_LOCATION_MIDDLE_TOWN_EAST - 1] = {MAP_GROUP(MIDDLE_TOWN_EAST), MAP_NUM(MIDDLE_TOWN_EAST), 21, 16},
    [HEAL_LOCATION_MIDDLE_TOWN_NORTH - 1] = {MAP_GROUP(MIDDLE_TOWN_NORTH), MAP_NUM(MIDDLE_TOWN_NORTH), 10, 23},
    [HEAL_LOCATION_MIDDLE_TOWN_SOUTH - 1] = {MAP_GROUP(MIDDLE_TOWN_SOUTH), MAP_NUM(MIDDLE_TOWN_SOUTH), 6, 9},
    [HEAL_LOCATION_CASTLE_TOWN_SABRE - 1] = {MAP_GROUP(CASTLE_TOWN_SABRE), MAP_NUM(CASTLE_TOWN_SABRE), 9, 32},
    [HEAL_LOCATION_CASTLE_TOWN_BLIND_JIM - 1] = {MAP_GROUP(CASTLE_TOWN_BLIND_JIM), MAP_NUM(CASTLE_TOWN_BLIND_JIM), 19, 20},
    [HEAL_LOCATION_CASTLE_TOWN_TMONEY - 1] = {MAP_GROUP(CASTLE_TOWN_TMONEY), MAP_NUM(CASTLE_TOWN_TMONEY), 10, 17},
    [HEAL_LOCATION_CASTLE_TOWN_HERMES - 1] = {MAP_GROUP(CASTLE_TOWN_HERMES), MAP_NUM(CASTLE_TOWN_HERMES), 11, 23},
    [HEAL_LOCATION_CASTLE_TOWN_TREBLE - 1] = {MAP_GROUP(CASTLE_TOWN_TREBLE), MAP_NUM(CASTLE_TOWN_TREBLE), 20, 24},
    [HEAL_LOCATION_CASTLE_TOWN_SALSA - 1] = {MAP_GROUP(CASTLE_TOWN_SALSA), MAP_NUM(CASTLE_TOWN_SALSA), 13, 14},
    [HEAL_LOCATION_CASTLE_TOWN_TOT - 1] = {MAP_GROUP(CASTLE_TOWN_TOT), MAP_NUM(CASTLE_TOWN_TOT), 8, 20},
    [HEAL_LOCATION_CASTLE_TOWN_ANDY - 1] = {MAP_GROUP(CASTLE_TOWN_ANDY), MAP_NUM(CASTLE_TOWN_ANDY), 19, 19},
};
