static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_STARTING_TOWN - 1] = {MAP_GROUP(STARTING_TOWN), MAP_NUM(STARTING_TOWN), 14, 6},
    [HEAL_LOCATION_MIDDLE_TOWN_WEST - 1] = {MAP_GROUP(MIDDLE_TOWN_WEST), MAP_NUM(MIDDLE_TOWN_WEST), 13, 18},
    [HEAL_LOCATION_MIDDLE_TOWN_EAST - 1] = {MAP_GROUP(MIDDLE_TOWN_EAST), MAP_NUM(MIDDLE_TOWN_EAST), 21, 16},
    [HEAL_LOCATION_MIDDLE_TOWN_NORTH - 1] = {MAP_GROUP(MIDDLE_TOWN_NORTH), MAP_NUM(MIDDLE_TOWN_NORTH), 4, 17},
    [HEAL_LOCATION_MIDDLE_TOWN_SOUTH - 1] = {MAP_GROUP(MIDDLE_TOWN_SOUTH), MAP_NUM(MIDDLE_TOWN_SOUTH), 4, 16},
    ...
    [HEAL_LOCATION_CASTLE_TOWN_TREBLE - 1] = {MAP_GROUP(CASTLE_TOWN_TREBLE), MAP_NUM(CASTLE_TOWN_TREBLE), 12, 12},
