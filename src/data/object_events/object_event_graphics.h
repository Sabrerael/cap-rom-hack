...
const u32 gObjectEventPic_RyanNormalRunning[] = INCBIN_U32("graphics/object_events/pics/people/ryan/walking.4bpp", "graphics/object_events/pics/people/ryan/running.4bpp");
const u16 gObjectEventPal_Ryan[] = INCBIN_U16("graphics/object_events/palettes/ryan.gbapal");
const u16 gObjectEventPal_RyanReflection[] = INCBIN_U16("graphics/object_events/palettes/ryan_reflection.gbapal");
const u16 gObjectEventPal_Treble[] = INCBIN_U16("graphics/object_events/palettes/treble.gbapal");
const u16 gObjectEventPal_TMoney[] = INCBIN_U16("graphics/object_events/palettes/tmoney.gbapal");
const u16 gObjectEventPal_Harold[] = INCBIN_U16("graphics/object_events/palettes/harold.gbapal");
const u16 gObjectEventPal_SlingRyan[] = INCBIN_U16("graphics/object_events/palettes/sling_ryan.gbapal");
const u16 gObjectEventPal_PirateRyan[] = INCBIN_U16("graphics/object_events/palettes/pirate_ryan.gbapal");
const u16 gObjectEventPal_Tot[] = INCBIN_U16("graphics/object_events/palettes/tot.gbapal");
const u16 gObjectEventPal_Salsa[] = INCBIN_U16("graphics/object_events/palettes/salsa.gbapal");
const u16 gObjectEventPal_Hermes[] = INCBIN_U16("graphics/object_events/palettes/hermes.gbapal");
const u16 gObjectEventPal_Jade[] = INCBIN_U16("graphics/object_events/palettes/jade.gbapal");
...
const u32 gObjectEventPic_Sabre[] = INCBIN_U32("graphics/object_events/pics/people/gym_leaders/sabre.4bpp");
const u32 gObjectEventPic_BlindJim[] = INCBIN_U32("graphics/object_events/pics/people/gym_leaders/blindjim.4bpp");
const u32 gObjectEventPic_Hermes[] = INCBIN_U32("graphics/object_events/pics/people/gym_leaders/hermes.4bpp");
const u32 gObjectEventPic_Salsa[] = INCBIN_U32("graphics/object_events/pics/people/gym_leaders/salsa.4bpp");
const u32 gObjectEventPic_Treble[] = INCBIN_U32("graphics/object_events/pics/people/gym_leaders/treble.4bpp");
const u32 gObjectEventPic_TMoney[] = INCBIN_U32("graphics/object_events/pics/people/gym_leaders/tmoney.4bpp");
const u32 gObjectEventPic_Tot[] = INCBIN_U32("graphics/object_events/pics/people/gym_leaders/tot.4bpp");
const u32 gObjectEventPic_Andy[] = INCBIN_U32("graphics/object_events/pics/people/gym_leaders/andy.4bpp");
const u32 gObjectEventPic_Pehbble[] = INCBIN_U32("graphics/object_events/pics/people/pehbble.4bpp");
const u32 gObjectEventPic_Harold[] = INCBIN_U32("graphics/object_events/pics/people/elite_four/harold.4bpp");
const u32 gObjectEventPic_SlingRyan[] = INCBIN_U32("graphics/object_events/pics/people/elite_four/sling_ryan.4bpp");
const u32 gObjectEventPic_PirateRyan[] = INCBIN_U32("graphics/object_events/pics/people/elite_four/pirate_ryan.4bpp");
