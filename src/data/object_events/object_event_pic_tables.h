...
static const struct SpriteFrameImage sPicTable_Sabre[] = {
    overworld_ascending_frames(gObjectEventPic_Sabre, 2, 4),
};

static const struct SpriteFrameImage sPicTable_BlindJim[] = {
    overworld_ascending_frames(gObjectEventPic_BlindJim, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Hermes[] = {
    overworld_ascending_frames(gObjectEventPic_Hermes, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Salsa[] = {
    overworld_ascending_frames(gObjectEventPic_Salsa, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Treble[] = {
    overworld_ascending_frames(gObjectEventPic_Treble, 2, 4),
};

static const struct SpriteFrameImage sPicTable_TMoney[] = {
    overworld_ascending_frames(gObjectEventPic_TMoney, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Tot[] = {
    overworld_ascending_frames(gObjectEventPic_Tot, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Andy[] = {
    overworld_ascending_frames(gObjectEventPic_Andy, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Pehbble[] = {
    overworld_ascending_frames(gObjectEventPic_Pehbble, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Harold[] = {
    overworld_ascending_frames(gObjectEventPic_Harold, 2, 4),
};

static const struct SpriteFrameImage sPicTable_SlingRyan[] = {
    overworld_ascending_frames(gObjectEventPic_SlingRyan, 2, 4),
};

static const struct SpriteFrameImage sPicTable_PirateRyan[] = {
    overworld_ascending_frames(gObjectEventPic_PirateRyan, 2, 4),
};
...
static const struct SpriteFrameImage sPicTable_RyanNormal[] = {
    overworld_ascending_frames(gObjectEventPic_RyanNormalRunning, 2, 4),
};

static const struct SpriteFrameImage sPicTable_Jadedosa[] = {
    overworld_ascending_frames(gObjectEventPic_Jadedosa, 2, 4),
};
