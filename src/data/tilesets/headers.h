...
const struct Tileset gTileset_CastleTownBlindJimGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CastleTownBlindJimGym,
    .palettes = gTilesetPalettes_CastleTownBlindJimGym,
    .metatiles = gMetatiles_CastleTownBlindJimGym,
    .metatileAttributes = gMetatileAttributes_CastleTownBlindJimGym,
    .callback = NULL,
};
...
const struct Tileset gTileset_CastleTownSabreGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CastleTownSabreGym,
    .palettes = gTilesetPalettes_CastleTownSabreGym,
    .metatiles = gMetatiles_CastleTownSabreGym,
    .metatileAttributes = gMetatileAttributes_CastleTownSabreGym,
    .callback = NULL,
};
...
const struct Tileset gTileset_CastleTownTrebleGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CastleTownTrebleGym,
    .palettes = gTilesetPalettes_CastleTownTrebleGym,
    .metatiles = gMetatiles_CastleTownTrebleGym,
    .metatileAttributes = gMetatileAttributes_CastleTownTrebleGym,
    .callback = NULL,
};

const struct Tileset gTileset_CastleTownTmoneyGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CastleTownTmoneyGym,
    .palettes = gTilesetPalettes_CastleTownTmoneyGym,
    .metatiles = gMetatiles_CastleTownTmoneyGym,
    .metatileAttributes = gMetatileAttributes_CastleTownTmoneyGym,
    .callback = NULL,
};

const struct Tileset gTileset_CastleTownTotGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CastleTownTotGym,
    .palettes = gTilesetPalettes_CastleTownTotGym,
    .metatiles = gMetatiles_CastleTownTotGym,
    .metatileAttributes = gMetatileAttributes_CastleTownTotGym,
    .callback = NULL,
};
