...
static u8 Debug_CheckToggleFlags(u8 id)
{
    ...
    switch (id)
    {
        ...
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_LOCATIONS:
            result = FlagGet(FLAG_VISITED_STARTING_TOWN) &&
                FlagGet(FLAG_VISITED_MIDDLE_TOWN_NORTH) &&
...
static void DebugAction_FlagsVars_ToggleFlyFlags(u8 taskId)
{
    ...
    {
        PlaySE(SE_PC_OFF);
        FlagClear(FLAG_VISITED_STARTING_TOWN);
        FlagClear(FLAG_VISITED_MIDDLE_TOWN_NORTH);
    ...
    {
        PlaySE(SE_PC_LOGIN);
        FlagSet(FLAG_VISITED_STARTING_TOWN);
        FlagSet(FLAG_VISITED_MIDDLE_TOWN_NORTH);
