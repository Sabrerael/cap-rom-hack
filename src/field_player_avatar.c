...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_RYAN_NORMAL,     OBJ_EVENT_GFX_RIVAL_MAY_NORMAL},
...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_RYAN_NORMAL,     OBJ_EVENT_GFX_MAY_NORMAL},
...
static const u8 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_RYAN_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
