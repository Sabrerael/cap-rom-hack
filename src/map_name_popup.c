...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_CASTLE_TOWN_SABRE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_CASTLE_TOWN_BLINDJIM] = MAPPOPUP_THEME_STONE,
    [MAPSEC_CASTLE_TOWN_ANDY] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_GUILD_COMMONS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CASTLE_TOWN_HERMES] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_CASTLE_TOWN_TREBLE] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_CASTLE_TOWN_TMONEY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_CASTLE_TOWN_SALSA] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_CASTLE_TOWN_TOT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_BASHETT_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_BARGEWRIGHT_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_STUMBULL_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SPEAKEASY_TOWN] = MAPPOPUP_THEME_WOOD,
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_CASTLE_TOWN_SABRE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CASTLE_TOWN_BLINDJIM] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CASTLE_TOWN_ANDY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_GUILD_COMMONS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CASTLE_TOWN_HERMES] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CASTLE_TOWN_TREBLE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CASTLE_TOWN_TMONEY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CASTLE_TOWN_SALSA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CASTLE_TOWN_TOT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_BASHETT_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_BARGEWRIGHT_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_STUMBULL_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SPEAKEASY_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
};
