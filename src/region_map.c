...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_GUILD_COMMONS] = {MAP_GROUP(STARTING_TOWN), MAP_NUM(STARTING_TOWN), HEAL_LOCATION_STARTING_TOWN},
};
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_GUILD_COMMONS:
        return FlagGet(FLAG_VISITED_STARTING_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_STUMBULL_TOWN:
        return FlagGet(FLAG_VISITED_MIDDLE_TOWN_NORTH) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_BARGEWRIGHT_TOWN:
        return FlagGet(FLAG_VISITED_MIDDLE_TOWN_EAST) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_BASHETT_TOWN:
        return FlagGet(FLAG_VISITED_MIDDLE_TOWN_SOUTH) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SPEAKEASY_TOWN:
        return FlagGet(FLAG_VISITED_MIDDLE_TOWN_WEST) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_STARTING_TOWN;
